...
describe('Album', () => {
  ...
  describe('getAlbumTracks', () => {
    ...
    it('should call correct URL', () => {
      ...
      expect(stubFetched).to.have.calledWith("https://api.spotify.com/v1/albums/4aawyAB9vmqN3uQ7FjRGTy/tracks");
  ...
  describe('getAlbums', () => {
    ...
    it("should call fetch method", () => {
      ...
      expect(stubFetched).to.have.calledWith("https://api.spotify.com/v1/albums?ids=382ObEPsp2rxGrnsizN5TX%1A2GTWGtFfWp7KSQTwWOyo");
    })
  })
});
